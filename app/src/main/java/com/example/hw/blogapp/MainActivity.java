...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle((Html.fromHtml("<font color='#f1f1f1'>Ashok Goyal App</font>")));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.fb:
                ...
                Uri ri = Uri.parse("https://www.facebook.com"); // missing 'http://' will cause crashed
            ...
            case  R.id.bio:
                ...
                Intent y = new Intent(MainActivity.this,Bio.class);
                startActivity(y);
                return true;
